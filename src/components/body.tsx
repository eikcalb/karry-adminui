...
export const Body = ({ showLoading }: { showLoading?: boolean }) => {
    ...
    if (showLoading) { return <BodyFragment loading /> }
        ...
        return (
            <Switch>
                <Route path={'/r/'} strict={true} component={RouteView} exact={false} />
                <Route path={'/'} strict={false} exact={true} component={RouteList} />
                <Route render={() => <BodyFragment loading={showLoading}>
